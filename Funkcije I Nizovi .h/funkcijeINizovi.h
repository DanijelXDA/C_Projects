#ifndef FUNKCIJEINIZOVI_H_INCLUDED
#define FUNKCIJEINIZOVI_H_INCLUDED

int funkcijaIzbor();
int odredjivanjeBrojaElemenataNiza(int *);
...
int odredjivanjeBrojaElemenataNiza(int *n)
{
...
#endif // FUNKCIJEINIZOVI_H_INCLUDED
